...
--
-- Host: localhost    Database: mt-store
-- ------------------------------------------------------
...
CREATE TABLE `brand` (
  ...
  `thumbnail` varchar(1023) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `brand` VALUES (1,'2021-09-18 15:10:53',0,'2021-09-18 15:10:53','','SAMSUNG','SAMSUNG','SAMSUNG','SAMSUNG','samsung','',1,1),(2,'2021-09-18 15:11:17',0,'2021-09-18 15:11:17','','Toshoba','Toshoba','Toshoba','Toshoba','toshoba','',1,1),(3,'2021-09-18 15:11:22',0,'2021-09-18 15:11:22','','LG','LG','LG','LG','lg','',1,1);
...
CREATE TABLE `category` (
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  `modified_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `banner` varchar(1023) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` varchar(2047) COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_description` varchar(2047) COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_keyword` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `meta_title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `image` (
  ...
  `link` varchar(1023) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `image` VALUES ('21d157e5-97cc-46b7-9456-d46da8e7ee3e','/media/static/21d157e5-97cc-46b7-9456-d46da8e7ee3e.jpg','file',42051,'jpg','2021-09-25 14:58:25',1),('44aca3c7-0364-444d-bad6-4bcc31a44b5d','/media/static/44aca3c7-0364-444d-bad6-4bcc31a44b5d.jpg','file',35890,'jpg','2021-09-25 14:58:07',1),('4d9bd196-9f40-404e-bb56-2c70e711d020','/media/static/4d9bd196-9f40-404e-bb56-2c70e711d020.jpg','file',47612,'jpg','2021-09-25 14:58:15',1),('5eed2964-112f-49f3-b5b4-17cb7a22a74f','/media/static/5eed2964-112f-49f3-b5b4-17cb7a22a74f.jpg','file',45398,'jpg','2021-09-25 14:58:38',1),('61b9a706-1e45-4b56-bc97-8ad688792b96','/media/static/61b9a706-1e45-4b56-bc97-8ad688792b96.jpg','file',29726,'jpg','2021-09-25 14:58:00',1),('78161211-a641-4a9e-961c-8fe2441e82ca','/media/static/78161211-a641-4a9e-961c-8fe2441e82ca.jpg','file',38557,'jpg','2021-09-25 14:58:04',1),('8902e6a7-244a-4820-9de5-1c388feee47c','/media/static/8902e6a7-244a-4820-9de5-1c388feee47c.jpg','file',47612,'jpg','2021-09-25 14:58:09',1),('b6cea029-86bc-4ff4-8272-fdfa3294ca67','/media/static/b6cea029-86bc-4ff4-8272-fdfa3294ca67.jpg','file',37557,'jpg','2021-09-25 14:58:12',1),('be88cf9d-fc55-4a6b-8089-ce669465b158','/media/static/be88cf9d-fc55-4a6b-8089-ce669465b158.jpg','file',57913,'jpg','2021-09-25 14:58:29',1),('d63ac10b-a130-4a0a-a552-a33576ee4ff1','/media/static/d63ac10b-a130-4a0a-a552-a33576ee4ff1.jpg','file',42792,'jpg','2021-09-25 14:58:20',1),('fb9b4b86-1c61-4db7-abd8-f2cde052aa6c','/media/static/fb9b4b86-1c61-4db7-abd8-f2cde052aa6c.jpg','file',45272,'jpg','2021-09-25 14:58:33',1);
...
CREATE TABLE `orders` (
  ...
  `note` varchar(511) COLLATE utf8_unicode_ci DEFAULT NULL,
  `payment_method` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `receiver_address` varchar(511) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `otp` (
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  `number_phone` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `post` (
  ...
  `slug` varchar(511) COLLATE utf8_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `thumbnail` varchar(511) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product` (
  ...
  `cover_image` varchar(511) COLLATE utf8_unicode_ci NOT NULL,
  `description` text COLLATE utf8_unicode_ci,
...
CREATE TABLE `users` (
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0',
  `modified_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `address` varchar(511) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2021-10-07  0:30:29
