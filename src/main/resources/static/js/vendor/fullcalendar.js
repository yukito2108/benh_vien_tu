...
var HitDragListener = /** @class */ (function (_super) {
    ...
    // Called when scrolling has stopped, whether through auto scroll, or the users scrolling
    HitDragListener.prototype.handleScrollEnd = function () {
        _super.prototype.handleScrollEnd.call(this);
        // hits' absolute positions will be in new places after a users's scroll.
...
var neededCount = 0;
/*
Listens to document and window-level users-interaction events, like touch events and mouse events,
...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    // Computes if the given event is allowed to be resized by the users at all
...
var View = /** @class */ (function (_super) {
    ...
    function View(calendar, viewSpec) {
        ...
        _this.isSelected = false; // boolean whether a range of time is users-selected or not
        _this.calendar = calendar;
...
var CoordCache = /** @class */ (function () {
    ...
    // Compute and return what the elements' bounding rectangle is, from the users's perspective.
...
var Calendar = /** @class */ (function () {
    ...
    // TODO: maintain any other users-manipulated state.
...
var EventResizing = /** @class */ (function (_super) {
    ...
    */
    ...
    // Creates a listener that tracks the users as they resize an event segment.
...
var EventDragging = /** @class */ (function (_super) {
    ...
    */
    ...
    // Builds a listener that will track users-dragging on an event segment.
    // Generic enough to work with any type of Grid.
    // Has side effect of setting/unsetting `dragListener`
...
var DateSelecting = /** @class */ (function (_super) {
    ...
    */
    ...
    // Creates a listener that tracks the users's drag across day elements, for day selecting.
    ...
    // Will return false if the selection is invalid and this should be indicated to the users.
...
var DateClicking = /** @class */ (function (_super) {
    ...
    */
    ...
    // Creates a listener that tracks the users's drag across day elements, for day clicking.
    DateClicking.prototype.buildDragListener = function () {
        ...
        var dragListener = new HitDragListener_1.default(component, {
            ...
            hitOver: function (hit, isOrig, origHit) {
                // if users dragged to another cell at any point, it can no longer be a dayClick
                if (!isOrig) {
                    dayClickHit = null;
                }
            },
...
var AgendaView = /** @class */ (function (_super) {
    ...
    /* Scroll
    ------------------------------------------------------------------------------------------------------------------*/
    // Computes the initial pre-configured scroll state prior to allowing the users to change it
