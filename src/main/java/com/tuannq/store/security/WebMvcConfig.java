...
public class  WebMvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(configInterceptor)
                .excludePathPatterns("/image/**", "/vendor/**", "/css/**", "/script/**", "/api/**", "/api/register", "/favicon.ico", "/adminlte/**", "/media/static/**", "/js/**", "/medikal1/**");
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/js/**").addResourceLocations("classpath:/static/js/")
                .setCacheControl(CacheControl.maxAge(2, TimeUnit.MILLISECONDS).cachePublic());
        registry.addResourceHandler("/medikal1/**").addResourceLocations("classpath:/static/medikal1/")
                .setCacheControl(CacheControl.maxAge(2, TimeUnit.MILLISECONDS).cachePublic());
    }
}
