...
public class Work extends BaseEntity {
    ...
    @ManyToMany
    @JoinTable(name = "works_providers", joinColumns = @JoinColumn(name = "id_work"), inverseJoinColumns = @JoinColumn(name = "id_users"))
    ...
    public void setProviders(List<Users> providers) {
