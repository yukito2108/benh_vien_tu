...
import com.tuannq.store.service.JwtTokenService;
...
public class JwtTokenServiceImpl implements JwtTokenService {
    ...
    public Long getAppointmentIdFromToken(String token) {
        Claims claims = Jwts.parser()
                ...
                .getBody();
        return (Long) claims.get("appointmentId");
    }
    ...
    public Long getCustomerIdFromToken(String token) {
        Claims claims = Jwts.parser()
                ...
                .parseClaimsJws(token)
                .getBody();
        return (Long) claims.get("customerId");
    }

    @Override
    public Long getProviderIdFromToken(String token) {
        Claims claims = Jwts.parser()
                .setSigningKey(jwtSecret)
                .parseClaimsJws(token)
                .getBody();
        return (Long) claims.get("providerId");
    }
